...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v3.0&appId=2027457724194832&autoLogAppEvents=1';
...
<div id="global-loader"></div>
        ...
        <div class="col-sm-12 col-xs-12 col-md-9">
           <nav id="desktop-menu">
              <ul class="sf-menu" id="navigation">
                 ...
                 <li>
                    <a href="#"><i class="fa fa-server"></i>Hebergements Web</a>
                    <ul>
                       <li><a href="<?php echo base_url(); ?>hebergement_web">Partagés</a></li>
                       <li><a href="<?php echo base_url(); ?>vps">Dédiés (VPS)</a></li>
                    </ul>
                 </li>
                 <li>
                    <a href="#"><i class="fa fa-globe"></i>Noms de Domaine</a>
                    <ul>
                 ...
                 <li>
                    <a href="<?php echo base_url(); ?>hebergement_web/about"><i class="fa fa-asterisk"></i>A Propos</a>
                    <ul>
                       <li><a href="<?php echo base_url(); ?>hebergement_web/testimonials">Testimonials</a></li>
                       <li><a href="<?php echo base_url(); ?>hebergement_web/blog">Blog</a></li>
                    </ul>
                 </li>
                 <li><a href="<?php echo base_url(); ?>hebergement_web/affiliate"><i class="fa fa-connectdevelop"></i>Affiliation</a></li>
                 <li>
                    <a href="#"><i class="fa fa-envelope fa-fw"></i>Contacts</a>
                 </li>
  ...
  <script src="<?= base_url()?>assets/js/facebook_login.js"></script>
  ...
  <script src='https://www.google.com/recaptcha/api.js'></script>
    ...
    <script>
		...
		var finalurl = 'https://new.mboahost.com/vps/ajouter_panier/'; //Update"domain.com" with your WHMCS installation URL
