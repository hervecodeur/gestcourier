          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><?php if ($liste[$i]->statut == 0): ?> Activer la Services<?php else: ?> Déactiver la Services<?php endif; ?></h4>
              </div>
              ...
              <a href="<?= base_url() ?>courrier/statut_categorie/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"><?php if ($liste[$i]->statut == 0): ?> Activer la Services<?php else: ?> Déactiver la Services<?php endif; ?></button>
              </a>
              </div>
            </div>
            <!-- /.modal-content -->
           ...
           <div class="modal  modal-danger fade" id="d<?php echo $liste[$i]->id ;?>">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> Supprimer la Services</h4>
              </div>
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir Supprimer la Services ?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>courrier/delete_categorie/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"> Supprimer la Services</button>
              </a>
              </div>
            </div>
          </div>
