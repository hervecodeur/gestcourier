...
class Auth extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->load->library(array('ion_auth', 'form_validation','back', 'layout'));
	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			else
			{
				...
				$this->load->view('auth/login', 'refresh'); // use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
	...
	/*if ($this->form_validation->run() === TRUE && $this->ion_auth->register($password, $email, $additional_data))
		...
		$this->back->view('auth/create_user', array('liste'=> $data),'refresh');
		}
	//$this->back->view('auth/create_user', array('code_parent'=> $code_parent));
	}
    ...
    public function insert(){
        ...
        //$this->load->view('bon-coin/liste_boncoins');
    }
